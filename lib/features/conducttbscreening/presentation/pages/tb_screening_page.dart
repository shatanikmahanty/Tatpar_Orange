...
class TBScreeningPage extends StatelessWidget {
  ...
  FormGroup _tbScreeningDetailsFormBuilder({required TBScreeningModel? tbScreeningModel, required SourceCubit cubit}) {
    ...
    return fb.group({
      ...
      'wheezing': FormControl<String?>(value: tbScreeningModel?.wheezing, validators: [Validators.required]),
      'shortness_breath':
          FormControl<String?>(value: tbScreeningModel?.shortnessBreath, validators: [Validators.required]),
      'tightness_chest':
          FormControl<String?>(value: tbScreeningModel?.tightnessChest, validators: [Validators.required]),
      'tb_medicine': FormControl<String?>(
        value: tbScreeningModel?.tbMedicine,
      ),
      'swasa_screening':
          FormControl<String?>(value: tbScreeningModel?.swasaScreening, validators: [Validators.required]),
      'swasa_screening_date':
          FormControl<DateTime>(value: tbScreeningModel?.swasaScreeningDate, validators: [Validators.required]),
      'swasa_screening_result': FormControl<String?>(
        value: tbScreeningModel?.swasaScreeningResult,
      ),
      'cxr_screening': FormControl<String?>(value: tbScreeningModel?.cxrScreening, validators: [Validators.required]),
      'cxr_screening_date':
          FormControl<DateTime>(value: tbScreeningModel?.cxrScreeningDate, validators: [Validators.required]),
                            ...
                            child: Padding(
                                ...
                                child: Column(children: [
                                  ...
                                  ChipRadioButtons(
                                    ...
                                    crossAxisCount: 2,
                                    onChanged: (value) {
                                      formGroup.control('cough').value = value.isNotEmpty ? value[0] : null;
                                    },
                                  ...
                                  ChipRadioButtons(
                                    ...
                                    crossAxisCount: 2,
                                    onChanged: (value) {
                                      formGroup.control('sputum').value = value.isNotEmpty ? value[0] : null;
                                    },
                                  ...
                                  ChipRadioButtons(
                                    ...
                                    crossAxisCount: 2,
                                    onChanged: (value) {
                                      formGroup.control('hemoptysis').value = value.isNotEmpty ? value[0] : null;
                                    },
                                  ...
                                  ChipRadioButtons(
                                    ...
                                    crossAxisCount: 2,
                                    onChanged: (value) {
                                      formGroup.control('fever').value = value.isNotEmpty ? value[0] : null;
                                    },
                                  ...
                                  ChipRadioButtons(
                                    ...
                                    crossAxisCount: 2,
                                    onChanged: (value) {
                                      formGroup.control('night_sweats').value = value.isNotEmpty ? value[0] : null;
                                    },
                                  ...
                                  ChipRadioButtons(
                                    ...
                                    crossAxisCount: 2,
                                    onChanged: (value) {
                                      formGroup.control('chest_pain').value = value.isNotEmpty ? value[0] : null;
                                    },
                                  ...
                                  ChipRadioButtons(
                                    ...
                                    crossAxisCount: 2,
                                    onChanged: (value) {
                                      formGroup.control('weight_loss').value = value.isNotEmpty ? value[0] : null;
                                  ...
                                  ChipRadioButtons(
                                    ...
                                    crossAxisCount: 2,
                                    onChanged: (value) {
                                      formGroup.control('swollen_gland').value = value.isNotEmpty ? value[0] : null;
                                    },
                                    selected: formGroup.control('swollen_gland').value,
                                  ),
                                  const SizedBox(height: kPadding * 2),
                                  ChipRadioButtons(
                                    label: AppLocalizations.of(context)!.wheezing,
                                    options: const ['Yes', 'No'],
                                    crossAxisCount: 2,
                                    onChanged: (value) {
                                      formGroup.control('wheezing').value = value.isNotEmpty ? value[0] : null;
                                    },
                                    selected: formGroup.control('wheezing').value,
                                  ),
                                  const SizedBox(height: kPadding * 2),
                                  ChipRadioButtons(
                                    label: AppLocalizations.of(context)!.shortnessOfBreath,
                                    options: const ['Yes', 'No'],
                                    crossAxisCount: 2,
                                    onChanged: (value) {
                                      formGroup.control('shortness_breath').value = value.isNotEmpty ? value[0] : null;
                                    },
                                    selected: formGroup.control('shortness_breath').value,
                                  ),
                                  const SizedBox(height: kPadding * 2),
                                  ChipRadioButtons(
                                    label: AppLocalizations.of(context)!.chestTightness,
                                    options: const ['Yes', 'No'],
                                    crossAxisCount: 2,
                                    onChanged: (value) {
                                      formGroup.control('tightness_chest').value = value.isNotEmpty ? value[0] : null;
                                    },
                                    selected: formGroup.control('tightness_chest').value,
                                  ),
                                  const SizedBox(height: kPadding * 2),
                                  ChipRadioButtons(
                                    ...
                                    crossAxisCount: 2,
                                    onChanged: (value) {
                                      formGroup.control('tb_medicine').value = value.isNotEmpty ? value[0] : null;
                                      // extractFormData(formGroup, context);
                                    },
                                  ...
                                  ChipRadioButtons(
                                    ...
                                    crossAxisCount: 2,
                                    onChanged: (value) {
                                      formGroup.control('pregnant').value = value.isNotEmpty ? value[0] : null;
                                    },
                                  ...
                                  ChipRadioButtons(
                                    crossAxisCount: 2,
                                    label: AppLocalizations.of(context)!.swasaScreening,
                                    options: const ['Yes', 'No'],
                                    selected: formGroup.control('swasa_screening').value,
                                    onChanged: (value) {
                                      formGroup.control('swasa_screening').value = value.isNotEmpty ? value[0] : null;
                                    },
                                  ),
                                  const SizedBox(height: kPadding * 2),
                                  ReactiveValueListenableBuilder<String?>(
                                      ...
                                      builder: (context, control, child) => Visibility(
                                          visible: formGroup.control('swasa_screening').value.toString() == 'Yes',
                                          child: Column(children: [
                                            DateTextInput(
                                              firstDate: DateTime(2002),
                                              controlName: 'swasa_screening_date',
                                              label: AppLocalizations.of(context)!.swaasaScreeningDate,
                                            ),
                                            const SizedBox(height: kPadding * 2),
                                            ChipRadioButtons(
                                              crossAxisCount: 2,
                                              label: AppLocalizations.of(context)!.swaasaScreeningResult,
                                              options: const ['Abnormal', 'Normal'],
                                              selected: formGroup.control('swasa_screening_result').value,
                                              onChanged: (value) {
                                                formGroup.control('swasa_screening_result').value =
                                                    value.isNotEmpty ? value[0] : null;
                                              },
                                            ),
                                            const SizedBox(height: kPadding * 2),
                                  ...
                                  ChipRadioButtons(
                                    crossAxisCount: 2,
                                    label: AppLocalizations.of(context)!.xrayAiScreening,
                                    options: const ['Yes', 'No'],
                                    selected: formGroup.control('cxr_screening').value,
                                    onChanged: (value) {
                                      formGroup.control('cxr_screening').value = value.isNotEmpty ? value[0] : null;
                                    },
                                  ),
                                  const SizedBox(height: kPadding * 2),
                                  ReactiveValueListenableBuilder<String?>(
                                      ...
                                      builder: (context, control, child) => Visibility(
                                          visible: formGroup.control('cxr_screening').value.toString() == 'Yes',
                                          child: Column(children: [
                                            DateTextInput(
                                              firstDate: DateTime(2002),
                                              controlName: 'cxr_screening_date',
                                              label: AppLocalizations.of(context)!.cxrscreeningDate,
                                            ),
                                            const SizedBox(height: kPadding * 2),
                                            ChipRadioButtons(
                                              crossAxisCount: 2,
                                              label: AppLocalizations.of(context)!.cxrScreeningResult,
                                              options: const ['Abnormal', 'Normal'],
                                              selected: formGroup.control('cxr_screening_result').value,
                                              onChanged: (value) {
                                                formGroup.control('cxr_screening_result').value =
                                                    value.isNotEmpty ? value[0] : null;
                                              },
                                            ),
                                            const SizedBox(height: kPadding * 2),
                                  ...
                                  ChipRadioButtons(
                                    ...
                                    options: const ['Presumptive CRD', 'EPTB', 'Normal'],
                                    selected: formGroup.control('screening_outcome').value,
                                    onChanged: (value) {
                                      formGroup.control('screening_outcome').value = value.isNotEmpty ? value[0] : null;
                                    },
                                  ),
                                  const SizedBox(height: kPadding * 2),
                                  PrimaryTextField(
