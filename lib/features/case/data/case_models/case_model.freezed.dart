...
abstract class _Case implements Case {
  const factory _Case(
      ...
      @HiveField(23)
      @JsonKey(includeToJson: false)
      final int? contactTracing}) = _$CaseImpl;
