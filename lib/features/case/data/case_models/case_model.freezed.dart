...
abstract class _Case implements Case {
  const factory _Case(
      ...
      @HiveField(24)
      @JsonKey(name: 'is_updated')
      final bool? isUpdated}) = _$CaseImpl;
