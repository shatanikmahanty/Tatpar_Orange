  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CaseCubit, CaseState>(
        builder: (context, state) => Scaffold(
            ...
            body: (state.isLoading || state.diagnsosisModel == null)
                ? Center(
                    child: Lottie.asset(
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return TextFieldWithList(
                                                                            controlName:
                                                                                'afb1_result',
                                                                            label:
                                                                                AppLocalizations.of(context)!.afb1Result,
                                                                            padding:
                                                                                EdgeInsets.zero,
                                                                            prefixIcon:
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return TextFieldWithList(
                                                                            controlName:
                                                                                'afb2_result',
                                                                            label:
                                                                                AppLocalizations.of(context)!.afb2Result,
                                                                            padding:
                                                                                EdgeInsets.zero,
                                                                            prefixIcon:
                                                                                Icons.account_circle_outlined,
                                                                    ...
                                                                    BlocBuilder<
                                                                        ...
                                                                        builder:
                                                                            (context,
                                                                                state) {
                                                                          List<String> list = (state.diagnosisData != null)
                                                                              ? state.diagnosisData!.naatMachine!.map((e) => '${e.name}').toList()
                                                                              : [];
                                                                          if (state.isLoading ??
                                                                              false) {
                                                                            return const SizedBox(
                                                                          ...
                                                                          return TextFieldWithList(
                                                                            controlName:
                                                                                'naat_machine',
                                                                            label:
                                                                                AppLocalizations.of(context)!.naatMachine,
                                                                            padding:
                                                                                EdgeInsets.zero,
                                                                            prefixIcon:
                                                                                Icons.account_circle_outlined,
                                                                    ...
                                                                    BlocBuilder<
                                                                        ...
                                                                        builder:
                                                                            (context,
                                                                                state) {
                                                                          List<String> list = (state.diagnosisData != null)
                                                                              ? state.diagnosisData!.mtbResult!.map((e) => '${e.name}').toList()
                                                                              : [];
                                                                          if (state.isLoading ??
                                                                              false) {
                                                                            return const SizedBox(
                                                                          ...
                                                                          return TextFieldWithList(
                                                                            controlName:
                                                                                'mtb_result',
                                                                            label:
                                                                                AppLocalizations.of(context)!.mtbResult,
                                                                            padding:
                                                                                EdgeInsets.zero,
                                                                            prefixIcon:
                                                                                Icons.account_circle_outlined,
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return TextFieldWithList(
                                                                            controlName:
                                                                                'xdr_result',
                                                                            label:
                                                                                AppLocalizations.of(context)!.xdrResult,
                                                                            padding:
                                                                                EdgeInsets.zero,
                                                                            prefixIcon:
                                                                                Icons.account_circle_outlined,
