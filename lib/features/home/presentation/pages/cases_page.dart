          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    context.router.navigate(const CasesFilterDialogRoute());
                  },
                  child: Container(
                    ...
                    padding: const EdgeInsets.symmetric(
                        vertical: kPadding * 1.8, horizontal: kPadding * 1.8),
                    child: const Icon(
            ...
            child: Padding(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (_, index) => AppFilterChip(
                    ...
                    isSelected: true,
                    //  (state.casesFilter.selectedShortCut ==
                    //     FilterShortCut.values[index]),
                    onCLicked: () {}
                    // cubit.applyPendingStageFilter(
                    //     FilterShortCut.values[index])
                    ),
