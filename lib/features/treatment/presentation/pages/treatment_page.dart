...
class TreatmentPage extends StatelessWidget {
  ...
  FormGroup _treatmentFormBuilder({required TreatmentModel? treatmentModel, required SourceCubit cubit}) {
    ...
    return fb.group({
      ...
      'case_history': FormControl<String>(value: treatmentModel?.caseHistory),
    ...
    return BlocBuilder<CaseCubit, CaseState>(
        builder: (context, state) => Scaffold(
            ...
            body: state.isLoading || state.caseWorkedUpon.treatment != null && state.treatmentModel == null
                ...
                : ReactiveFormBuilder(
                    form: () =>
                        _treatmentFormBuilder(treatmentModel: state.treatmentModel, cubit: context.read<SourceCubit>()),
                                ...
                                child: SingleChildScrollView(
                                    child: Padding(
                                        ...
                                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                          ChipRadioButtons(
                                            label: AppLocalizations.of(context)!.caseDefinition,
                                            options: const ['MCB', 'CD'],
                                            crossAxisCount: 2,
                                            onChanged: (value) {
                                              formGroup.control('case_definition').value = value;
                                            },
                                            selected: formGroup.control('case_definition').value,
                                          ),
                                          const SizedBox(height: kPadding * 2),
                                          ChipRadioButtons(
                                            label: AppLocalizations.of(context)!.tbSite,
                                          ...
                                          const SizedBox(height: kPadding * 2),
                                          ChipRadioButtons(
                                            label: AppLocalizations.of(context)!.caseHistory,
                                            options: const [
                                              'New',
                                              'Previously Treated',
                                              'Recurrent',
                                            ...
                                            crossAxisCount: 3,
                                            onChanged: (value) {
                                              formGroup.control('case_history').value = value;
                                            },
                                            selected: formGroup.control('case_history').value,
                                          ),
                                          const SizedBox(height: kPadding * 2),
                                          ChipRadioButtons(
                                            label: AppLocalizations.of(context)!.drugSensitive,
                                            options: const ['Sensitive', 'Resistant'],
                                            crossAxisCount: 2,
                                            onChanged: (value) {
                                              formGroup.control('drug_sensitive').value = value;
                                            },
                                            selected: formGroup.control('drug_sensitive').value,
                                          ),
                                          const SizedBox(height: kPadding * 2),
                                          ChipRadioButtons(
                                            label: AppLocalizations.of(context)!.diagnosisStatus,
                                            options: const ['PTLFU', 'On Treatment'],
                                            crossAxisCount: 2,
                                            onChanged: (value) {
                                              formGroup.control('diagnosis_status').value = value;
                                            },
                                          ...
                                          ReactiveValueListenableBuilder<String>(
                                              ...
                                              builder: (context, control, child) => Visibility(
                                                  visible:
                                                      (formGroup.control('diagnosis_status').value) == 'On Treatment',
                                                  child: Column(children: [
                                                    DateTextInput(
                                                      firstDate: DateTime(2002),
                                                      controlName: 'ihv_date',
                                                      label: AppLocalizations.of(context)!.ihvDate,
                                                    ),
                                                    const SizedBox(height: kPadding * 2),
                                                    ChipRadioButtons(
                                                      label: AppLocalizations.of(context)!.treatmentRegimen,
                                                      options: const ['New', 'Previous'],
                                                      crossAxisCount: 2,
                                                      onChanged: (value) {
                                                        formGroup.control('treatment_regimen').value = value;
                                                      },
                                                    ...
                                                    PrimaryTextField(
                                                      ...
                                                      label: AppLocalizations.of(context)!.patientOccupation,
                                                      prefixIcon: Icons.account_circle_outlined,
                                                    ),
                                                    const SizedBox(height: kPadding * 2),
                                                    PrimaryTextField(
                                                      formControlName: 'treatment_supporter_name',
                                                      label: AppLocalizations.of(context)!.treatmentSupporterName,
                                                      prefixIcon: Icons.account_circle_outlined,
                                                    ),
                                                    const SizedBox(height: kPadding * 2),
                                                    TextFieldWithList(
                                                      controlName: 'treatment_supporter_position',
                                                      label: AppLocalizations.of(context)!.treatmentSupporterPosition,
                                                    ...
                                                    PrimaryTextField(
                                                      ...
                                                      label: AppLocalizations.of(context)!.treatmentSupporterPhone,
                                                    ...
                                                    PrimaryTextField<int>(
                                                      ...
                                                      label: AppLocalizations.of(context)!.treatmentSupporterWard,
                                                      prefixIcon: Icons.account_circle_outlined,
                                                    ),
                                                    const SizedBox(height: kPadding * 2),
                                                    PrimaryTextField(
                                                    ...
                                                    ChipRadioButtons(
                                                      ...
                                                      crossAxisCount: 3,
                                                      onChanged: (value) {
                                                        formGroup.control('stage').value = value;
                                                      },
                                                    ...
                                                    ReactiveValueListenableBuilder<String>(
                                                        ...
                                                        builder: (context, control, child) => Visibility(
                                                            ...
                                                            child: Column(children: [
                                                              ...
                                                              ChipRadioButtons(
                                                                label:
                                                                    AppLocalizations.of(context)!.screeningForNutrition,
                                                                options: const ['Yes', 'No'],
                                                                crossAxisCount: 2,
                                                                onChanged: (value) {
                                                    ...
                                                    ReactiveValueListenableBuilder<String>(
                                                        ...
                                                        builder: (context, control, child) => Visibility(
                                                            ...
                                                            child: Column(children: [
                                                                  ...
                                                                  builder: (context, control, child) => Visibility(
                                                                      ...
                                                                      child: Column(children: [
                                                                        DateTextInput(
                                                                          ...
                                                                          label:
                                                                              AppLocalizations.of(context)!.ipfuAfbDate,
                                                                        ),
                                                                        const SizedBox(height: kPadding * 2),
                                                                        PrimaryTextField(
                                                              ...
                                                              BlocBuilder<SourceCubit, SourceState>(
                                                                  ...
                                                                  builder: (context, state) {
                                                                    ...
                                                                    return TextFieldWithList(
                                                                      ...
                                                                      label:
                                                                          AppLocalizations.of(context)!.ipfuNaatResult,
                                                                      padding: EdgeInsets.zero,
                                                                      prefixIcon: Icons.account_circle_outlined,
                                                                      listData: list,
                                                                      allowMultiSelection: false,
                                                                      onSelected: (value) {
                                                                        formGroup.control('ipfu_naat_result').value =
                                                                            value[0];
                                                                      },
                                                                      emptyString: '',
                                                                    );
                                                              ...
                                                              ChipRadioButtons(
                                                                label:
                                                                    AppLocalizations.of(context)!.ipfuNutritionSupport,
                                                                options: const ['Yes', 'No'],
                                                                crossAxisCount: 2,
                                                                onChanged: (value) {
                                                                  ...
                                                                  builder: (context, control, child) => Visibility(
                                                                      ...
                                                                      child: Column(children: [
                                                                        DateTextInput(
                                                                          ...
                                                                          label:
                                                                              AppLocalizations.of(context)!.cpAfbDate,
                                                                        ),
                                                                        const SizedBox(height: kPadding * 2),
                                                                        PrimaryTextField(
                                                                          formControlName: 'cp_afb_lab_no',
                                                                          label:
                                                                              AppLocalizations.of(context)!.cpAfbLabNo,
                                                                          prefixIcon: Icons.account_circle_outlined,
                                                                        ),
                                                                        const SizedBox(height: kPadding * 2),
                                                                        BlocBuilder<SourceCubit, SourceState>(
                                                              ...
                                                              BlocBuilder<SourceCubit, SourceState>(
                                                                  ...
                                                                  builder: (context, state) {
                                                                    ...
                                                                    return TextFieldWithList(
                                                                      ...
                                                                      allowMultiSelection: false,
                                                                      onSelected: (value) {
                                                                        formGroup.control('cp_naat_result').value =
                                                                            value[0];
                                                                      },
                                                                      emptyString: '',
                                                                    );
